        ...
        <div class="packages" id="packages">
            ...
            <table class="table-cities">
                <tr>
                    ...
                    <th style="text-align:center;">space area</th>
                </tr>
                <tr>
                    <td>Casablanca</td>
                    <td>3,359,818 Population</td>
                    <td>195.23 km<sup>2</sup></td>
                </tr>
                <tr>
                    <td>Fez</td>
                    <td>1,112,072 Population</td>
                    <td>96.55 km<sup>2</sup></td>
                </tr>
                <tr>
                    <td>Tanger</td>
                    <td>947,952 Population</td>
                    <td>164.71 km<sup>2</sup></td>
                </tr>
            </table>
