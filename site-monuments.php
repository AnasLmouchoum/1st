...
<head>
    ...
    <title>Morocco Sites&Monuments</title>
...
<!-- home section starts  -->
    ...
    <section class="home" id="home">
        ...
        <div class="packages" id="packages">
            ...
            <div class="monuments">
                <img src="Photos/fes.jpg" alt="" style="height:100%;width:300px;border-top-left-radius:12px;border-bottom-left-radius:12px;">
                <div>
                    <h3 style="color:yellow;">Alqarawiyyin</h3> 
                    <p>The University of al-Qarawiyyin (Arabic: جامعة القرويين; Berber : ⵜⴰⵙⴷⴰⵡⵉⵜ ⵏ ⵍⵇⴰⵕⴰⵡⵉⵢⵢⵉⵏ; French: Université Al Quaraouiyine), also written Al-Karaouine or Al Quaraouiyine, is a university located in Fez, Morocco. It was founded as a mosque by Fatima al-Fihri in 857–859 and subsequently became one of the leading spiritual and educational centers of the historic Muslim world. It was incorporated into Morocco's modern state university system in 1963 and was officially renamed "University of Al Quaraouiyine" two years later.[1] The mosque building itself is also a significant complex of historical Moroccan and Islamic architecture encompassing elements from many different periods of Moroccan history.</p>
                </div>
                
            </div>
            <div class="monuments">
                <img src="Photos/oualili.jpg" alt="" style="height:100%;width:300px;border-top-left-radius:12px;border-bottom-left-radius:12px;"">
                <div>
                    <h3 style="color:yellow;">Oualili</h3>
                    <p>Volubilis is an ancient Roman city located on the banks of Oued Khoumane, a river in the suburbs of Meknes (Morocco), not far from the holy city of Moulay Idriss Zerhoun where Idrîs I rests. Municipalities & Cities of Morocco strives to identify all the useful information of towns and municipalities in Morocco and in particular the municipality of Oualili / Volubilis and has no direct link with the town hall or the state. Find the coordinates of the town hall of Oualili / Volubilis for your administrative procedures in Oualili / Volubilis and all the local information of the municipality and the inhabitants.</p>
                </div>
            </div>
            <div class="monuments">
                <img src="Photos/tower.jpg" alt="" style="height:100%;width:300px;border-top-left-radius:12px;border-bottom-left-radius:12px;"">
                <div>
                    <h3 style="color:yellow;">Hassan Tower</h3>
                    <p>Hassan Tower or Tour Hassan (Arabic: صومعة حسان; Berber languages: ⵙⵓⵎⵓⵄⵜ ⵏ ⵃⴰⵙⵏ) is the minaret of an incomplete mosque in Rabat, Morocco.[1] It was commissioned by Abu Yusuf Yaqub al-Mansur, the third Caliph of the Almohad Caliphate, near the end of the 12th century. The tower was intended to be the largest minaret in the world,[2] and the mosque, if completed, would have been the largest in the western Muslim world. When al-Mansur died in 1199, construction on the mosque stopped. The minaret was left standing at a height of 44 meters.[3] The rest of the mosque was also left incomplete, with only the beginnings of several walls and 348 columns being constructed.[4] The tower, along with the remains of the mosque and the modern Mausoleum of Mohammed V, forms an important historical and tourist complex in Rabat</p>
                </div>
            </div>
